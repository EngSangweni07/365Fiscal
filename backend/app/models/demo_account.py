...
class DemoAccount(Base, TimestampMixin):
    ...
    payment_link: Mapped[str] = mapped_column(String(1000), default="")
    payment_method: Mapped[str] = mapped_column(String(20), default="")
    ecocash_phone_number: Mapped[str] = mapped_column(String(20), default="")
    paynow_reference: Mapped[str] = mapped_column(String(100), default="")
    paynow_poll_url: Mapped[str] = mapped_column(String(1000), default="")
    paynow_status: Mapped[str] = mapped_column(String(50), default="")
    paynow_paid_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
