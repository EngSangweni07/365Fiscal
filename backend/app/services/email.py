          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:720px;background:#ffffff;border-radius:24px;overflow:hidden;border:1px solid #dbe5ea;box-shadow:0 24px 60px rgba(15,23,42,.12);">
            <tr>
              <td style="background:#ffffff;padding:22px 28px;border-bottom:4px solid #d1e826;">
                <div style="display:inline-flex;align-items:center;justify-content:center;padding:12px 18px;border-radius:20px;background:linear-gradient(180deg,#ffffff 0%,#f8fbfc 100%);border:1px solid #dbe5ea;box-shadow:0 12px 28px rgba(15,23,42,.1);margin:0 0 18px;">
                  <img src="cid:three65-logo" alt="Three65" style="display:block;width:240px;max-width:240px;max-height:none;height:auto;" />
                </div>
